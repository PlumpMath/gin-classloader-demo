...
java -cp "$CLASSPATH" org.example.gin.classloader.demo.GwtCompilerRunner fix-2/out/gin-classloader-fix-2.jar lib/gin-*.jar gwt-example-project/out/gwt-example-project.jar
