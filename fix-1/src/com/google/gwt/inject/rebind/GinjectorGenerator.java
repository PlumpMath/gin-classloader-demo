...
import com.google.gwt.inject.rebind.GinBridgeClassLoader;
...
public class GinjectorGenerator extends Generator {
   ...
   * @see com.google.gwt.inject.rebind.GinBridgeClassLoader
   */
  ...
  private Class<? extends Ginjector> getGinjectorType(String requestedClass)
    ...
    Class<?> ginjectorClass = loadClass("com.google.gwt.inject.client.Ginjector", false);
    if (!ginjectorClass.isAssignableFrom(type)) {
