...
java -cp "$CLASSPATH" org.example.gin.classloader.demo.GwtCompilerRunner fix-3/out/gin-classloader-fix-3.jar lib/gin-*.jar gwt-example-project/out/gwt-example-project.jar
