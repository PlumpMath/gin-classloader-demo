...
class GinBridgeClassLoader extends ClassLoader {
    ...
    GinBridgeClassLoader(GeneratorContext context, TreeLogger logger,
        ...
        super(GinBridgeClassLoader.class.getClassLoader()); // Use own class loader by default.
     ...
     * GWT generated or super-source classes. See description {@link com.google.gwt.inject.rebind.GinBridgeClassLoader above}.
     */
    @Override
    ...
    /**
     * Retrieves class definitions from a {@link com.google.gwt.core.ext.GeneratorContext} by downcasting.
     */
