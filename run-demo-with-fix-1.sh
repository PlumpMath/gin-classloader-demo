...
java -cp "$CLASSPATH" org.example.gin.classloader.demo.GwtCompilerRunner fix-1/out/gin-classloader-fix-1.jar lib/gin-*.jar gwt-example-project/out/gwt-example-project.jar
